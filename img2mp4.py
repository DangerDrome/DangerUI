...
from lib.ui.ui_interface import Ui_MainWindow
...
class mainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.actionClose.triggered.connect(self.close)  # Connect to built-in close method
        self.ui.actionMinimize.triggered.connect(self.showMinimized)  # Use built-in method for minimizing
...
def main():
    ...
    parser.add_argument('-r', '--framerate', help="Frame rate (default: 24)", type=int, default=24)
    ...
    if resolution:
        ...
        print("Failed to obtain resolution of input images. Aborting.")
        sys.exit(1)
